...
class CQCCNN_Z_network(nn.Module):
    def __init__(self, type = 1, board_size=3, n_qubits = 10):
        super().__init__()
        self.board_size = board_size
...
class CQCNN_estimator_ZR_network(nn.Module):
    def __init__(self, type = 1, board_size=3, num_of_qubit=10, featuremap_reps=1, ansatz_reps=1):
        super().__init__()
        self.board_size = board_size
        self.num_of_qubit = num_of_qubit
        self.linear1 = nn.Linear(9, self.num_of_qubit, bias=True)
...
class QCNN_Z_network(nn.Module):
    def __init__(self, type = 1, board_size=3):
        super().__init__()
        self.board_size=board_size
